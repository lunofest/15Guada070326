...
function updateTimer() {
  const targetDate = new Date("march 7, 2026 21:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '543815478899'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543812062312'; // Número para el primer botón
  const recipientNumber2 = '543861512463'; // Número para el segundo botón
  const recipientNumber3 = '543813527596'; // Número para el tercer botón
